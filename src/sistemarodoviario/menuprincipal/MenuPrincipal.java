...
import sistemarodoviario.funcionalidades.FuncionalidadesMicroonibus;
...
public class MenuPrincipal {
    ...
    public static void main(String[] args) {
       ...
       FuncionalidadesMicroonibus MicroOnibus = new FuncionalidadesMicroonibus();
